...
description: SpaceX-inspired DESIGN.md — futuristic brutalism. Pure black canvas, full-bleed photographic heroes, uppercase D-DIN display type, single ghost-outlined pill button per band. Use this reference when the brief calls for aerospace, defense, hardware, industrial, or any product whose voice is "we have nothing to prove."
keywords:
  - brutalist
  - minimal
  - monochrome
