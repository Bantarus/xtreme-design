---
name: editorial-heritage-starbucks
description: Starbucks-inspired DESIGN.md — warm retail heritage. Warm-neutral canvas, four-tier green system, mixed typographic voices (sans + serif + script for specific moments), 50px pills and 12px cards. Use this reference when the brief calls for retail, hospitality, craft, food, or any product where the chrome itself signals warmth and history.
keywords:
  - editorial
  - heritage
  - retail
