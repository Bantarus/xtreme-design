...
description: Stripe-inspired DESIGN.md — premium fintech SaaS. Deep navy ink, electric indigo primary, recurring gradient mesh, thin-weight editorial-density display type, tabular numerics. Use this reference when the brief calls for B2B SaaS, fintech, developer tools, or any product where credibility is the brand.
keywords:
  - saas
  - minimal
  - enterprise
