---
name: consumer-vivid-spotify
description: Spotify-inspired DESIGN.md — vivid consumer entertainment. Near-black immersive canvas, single bright-green accent, pill geometry, content-first chrome. Use this reference when the brief calls for music, video, streaming, social, or any product where mood and saturation matter more than information density.
keywords:
  - consumer
  - vivid
  - music
