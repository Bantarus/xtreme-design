---
version: alpha
name: MySpace Glitter
description: Hot-pink Comic-Sans-coded social profile circa 2006, glitter GIF energy on default-blue chrome.
colors:
  primary: "#ff2e88"
  primary-hover: "#cf1f6a"
  on-primary: "#ffffff"
  surface: "#fff4fb"
  surface-muted: "#ffd9ee"
  text: "#1d0a1a"
  text-muted: "#7a4a6a"
  border: "#ffa6d4"
  border-strong: "#ff5fa9"
  success: "#5ad27a"
  danger: "#ff3344"
  warning: "#ffd000"
  info: "#2c8df0"
...
Hot-pink Comic-Sans-coded social profile circa 2006, glitter GIF energy on default-blue chrome. Inspired by MySpace profiles / GeoCities revival. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#ff2e88):** The single decisive interaction color per view.
- **Primary Hover (#cf1f6a):** Pressed/hover state for primary.
- **On Primary (#ffffff):** Foreground on primary fills.
- **Surface (#fff4fb):** Default page and card background.
- **Surface Muted (#ffd9ee):** Section bands and code blocks.
- **Text (#1d0a1a):** Body and heading copy.
- **Text Muted (#7a4a6a):** Captions and metadata.
- **Border (#ffa6d4):** Hairline between cards, inputs, rows.
- **Border Strong (#ff5fa9):** Reinforced border on muted surfaces.
- **Success (#5ad27a):** Confirmation and completion states.
- **Danger (#ff3344):** Destructive actions and validation errors.
- **Warning (#ffd000):** Non-blocking cautions.
- **Info (#2c8df0):** Neutral informational states.
- **Focus Ring (#00e0ff):** Keyboard focus indicator at 2px outer offset.

## Typography

Two families plus a monospace: **Pacifico** for display, headlines, and titles; **Comic Neue** for body copy and labels; **VT323** for inline code, IDs, and tabular numerics. Display weight 400; body weight 400.
