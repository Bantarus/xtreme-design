...
version: alpha
name: Polaris Forest
description: Shopify merchant-first — deep forest primary, dependable beige rails, no flourish.
colors:
  primary: "#008060"
...
Shopify merchant-first — deep forest primary, dependable beige rails, no flourish. Inspired by Shopify Polaris. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#008060):** The single decisive interaction color per view.
- **Primary Hover (#004c3f):** Pressed/hover state for primary.
- **On Primary (#ffffff):** Foreground on primary fills.
- **Surface (#ffffff):** Default page and card background.
- **Surface Muted (#f6f6f7):** Section bands and code blocks.
- **Text (#202223):** Body and heading copy.
- **Text Muted (#6d7175):** Captions and metadata.
- **Border (#e1e3e5):** Hairline between cards, inputs, rows.
- **Border Strong (#8c9196):** Reinforced border on muted surfaces.
- **Success (#008060):** Confirmation and completion states.
- **Danger (#d72c0d):** Destructive actions and validation errors.
- **Warning (#b98900):** Non-blocking cautions.
- **Info (#2c6ecb):** Neutral informational states.
- **Focus Ring (#458fff):** Keyboard focus indicator at 2px outer offset.
