...
version: alpha
name: Stripe Indigo
description: Founder-coded fintech — white canvas, indigo gradient lockup, Söhne-via-Inter confidence.
colors:
  primary: "#635bff"
...
Founder-coded fintech — white canvas, indigo gradient lockup, Söhne-via-Inter confidence. Inspired by Stripe.com 2014–2018. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#635bff):** The single decisive interaction color per view.
- **Primary Hover (#4a44d6):** Pressed/hover state for primary.
- **On Primary (#ffffff):** Foreground on primary fills.
- **Surface (#ffffff):** Default page and card background.
- **Surface Muted (#f6f9fc):** Section bands and code blocks.
- **Text (#0a2540):** Body and heading copy.
- **Text Muted (#425466):** Captions and metadata.
- **Border (#e3e8ee):** Hairline between cards, inputs, rows.
- **Border Strong (#8898aa):** Reinforced border on muted surfaces.
- **Success (#00d924):** Confirmation and completion states.
- **Danger (#ff5996):** Destructive actions and validation errors.
- **Warning (#ffae00):** Non-blocking cautions.
- **Info (#008cdd):** Neutral informational states.
- **Focus Ring (#635bff):** Keyboard focus indicator at 2px outer offset.

## Typography

Two families plus a monospace: **Inter** for display, headlines, and titles; **Inter** for body copy and labels; **IBM Plex Mono** for inline code, IDs, and tabular numerics. Display weight 600; body weight 400.
