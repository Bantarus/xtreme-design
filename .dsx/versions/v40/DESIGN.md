...
description: Chrysler Building gold on midnight onyx, fan motifs, Gatsby-coded ceremony.
colors:
  primary: "#c9a04a"
  primary-hover: "#9d7a2c"
  on-primary: "#0d0a08"
  surface: "#0d0a08"
  surface-muted: "#1a140e"
  text: "#f5e9d0"
  text-muted: "#b09567"
  border: "#3a2c1a"
  border-strong: "#c9a04a"
  success: "#7ab37a"
  danger: "#c44a3a"
  warning: "#e6b450"
  info: "#6a8caf"
...
Chrysler Building gold on midnight onyx, fan motifs, Gatsby-coded ceremony. Inspired by Art Deco 1925 / Chrysler Building lobby. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#c9a04a):** The single decisive interaction color per view.
- **Primary Hover (#9d7a2c):** Pressed/hover state for primary.
- **On Primary (#0d0a08):** Foreground on primary fills.
- **Surface (#0d0a08):** Default page and card background.
- **Surface Muted (#1a140e):** Section bands and code blocks.
- **Text (#f5e9d0):** Body and heading copy.
- **Text Muted (#b09567):** Captions and metadata.
- **Border (#3a2c1a):** Hairline between cards, inputs, rows.
- **Border Strong (#c9a04a):** Reinforced border on muted surfaces.
- **Success (#7ab37a):** Confirmation and completion states.
- **Danger (#c44a3a):** Destructive actions and validation errors.
- **Warning (#e6b450):** Non-blocking cautions.
- **Info (#6a8caf):** Neutral informational states.
- **Focus Ring (#c9a04a):** Keyboard focus indicator at 2px outer offset.

## Typography

Two families plus a monospace: **Cinzel** for display, headlines, and titles; **Cormorant Garamond** for body copy and labels; **Courier Prime** for inline code, IDs, and tabular numerics. Display weight 600; body weight 400.
