...
description: P1 phosphor on black, VT220 monospace, 1983 mainframe nostalgia.
colors:
  primary: "#33ff33"
  primary-hover: "#22cc22"
  on-primary: "#000000"
  surface: "#000000"
  surface-muted: "#0a1a0a"
  text: "#33ff33"
  text-muted: "#1d8c1d"
  border: "#155515"
  border-strong: "#22aa22"
  success: "#aaffaa"
  danger: "#ff5555"
  warning: "#ffff55"
  info: "#55ffff"
...
P1 phosphor on black, VT220 monospace, 1983 mainframe nostalgia. Inspired by DEC VT220 / classic UNIX terminals. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#33ff33):** The single decisive interaction color per view.
- **Primary Hover (#22cc22):** Pressed/hover state for primary.
- **On Primary (#000000):** Foreground on primary fills.
- **Surface (#000000):** Default page and card background.
- **Surface Muted (#0a1a0a):** Section bands and code blocks.
- **Text (#33ff33):** Body and heading copy.
- **Text Muted (#1d8c1d):** Captions and metadata.
- **Border (#155515):** Hairline between cards, inputs, rows.
- **Border Strong (#22aa22):** Reinforced border on muted surfaces.
- **Success (#aaffaa):** Confirmation and completion states.
- **Danger (#ff5555):** Destructive actions and validation errors.
- **Warning (#ffff55):** Non-blocking cautions.
- **Info (#55ffff):** Neutral informational states.
- **Focus Ring (#aaffaa):** Keyboard focus indicator at 2px outer offset.

## Typography

Two families plus a monospace: **VT323** for display, headlines, and titles; **VT323** for body copy and labels; **VT323** for inline code, IDs, and tabular numerics. Display weight 400; body weight 400.
