...
description: Frosted-glass cards over an aurora gradient — macOS Big Sur, but for marketing.
colors:
  primary: "#7c5cff"
  primary-hover: "#5b3fd6"
  on-primary: "#ffffff"
  surface: "#f7f4ff"
  surface-muted: "#eae3ff"
  text: "#1a1235"
  text-muted: "#5d5380"
  border: "#d8cffb"
  border-strong: "#a394ec"
  success: "#3ed598"
  danger: "#ff5d8f"
  warning: "#ffb547"
  info: "#4ad3ff"
...
Frosted-glass cards over an aurora gradient — macOS Big Sur, but for marketing. Inspired by macOS Big Sur / Windows 11 Mica / 2021 Dribbble. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#7c5cff):** The single decisive interaction color per view.
- **Primary Hover (#5b3fd6):** Pressed/hover state for primary.
- **On Primary (#ffffff):** Foreground on primary fills.
- **Surface (#f7f4ff):** Default page and card background.
- **Surface Muted (#eae3ff):** Section bands and code blocks.
- **Text (#1a1235):** Body and heading copy.
- **Text Muted (#5d5380):** Captions and metadata.
- **Border (#d8cffb):** Hairline between cards, inputs, rows.
- **Border Strong (#a394ec):** Reinforced border on muted surfaces.
- **Success (#3ed598):** Confirmation and completion states.
- **Danger (#ff5d8f):** Destructive actions and validation errors.
- **Warning (#ffb547):** Non-blocking cautions.
- **Info (#4ad3ff):** Neutral informational states.
- **Focus Ring (#4ad3ff):** Keyboard focus indicator at 2px outer offset.

## Typography

Two families plus a monospace: **Plus Jakarta Sans** for display, headlines, and titles; **Plus Jakarta Sans** for body copy and labels; **JetBrains Mono** for inline code, IDs, and tabular numerics. Display weight 600; body weight 400.
