---
version: alpha
name: Risograph Fluoro
description: Fluoro-pink-on-teal misregistration, zine-press grain, art-school photocopier joy.
colors:
  primary: "#ff48b0"
  primary-hover: "#d62888"
  on-primary: "#fffae8"
  surface: "#fffae8"
  surface-muted: "#f0e8c8"
  text: "#0d1a2a"
  text-muted: "#445a6a"
  border: "#0d1a2a"
  border-strong: "#0d1a2a"
  success: "#00a95c"
  danger: "#ff665e"
  warning: "#ffb511"
  info: "#00838a"
...
Fluoro-pink-on-teal misregistration, zine-press grain, art-school photocopier joy. Inspired by Risograph printing / DIY zines. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#ff48b0):** The single decisive interaction color per view.
- **Primary Hover (#d62888):** Pressed/hover state for primary.
- **On Primary (#fffae8):** Foreground on primary fills.
- **Surface (#fffae8):** Default page and card background.
- **Surface Muted (#f0e8c8):** Section bands and code blocks.
- **Text (#0d1a2a):** Body and heading copy.
- **Text Muted (#445a6a):** Captions and metadata.
- **Border (#0d1a2a):** Hairline between cards, inputs, rows.
- **Border Strong (#0d1a2a):** Reinforced border on muted surfaces.
- **Success (#00a95c):** Confirmation and completion states.
- **Danger (#ff665e):** Destructive actions and validation errors.
- **Warning (#ffb511):** Non-blocking cautions.
- **Info (#00838a):** Neutral informational states.
- **Focus Ring (#ff48b0):** Keyboard focus indicator at 2px outer offset.

## Typography

Two families plus a monospace: **Bagel Fat One** for display, headlines, and titles; **DM Sans** for body copy and labels; **Space Mono** for inline code, IDs, and tabular numerics. Display weight 700; body weight 400.
