...
description: Blurple banners, dark guild sidebar, channel-list at 2am gamer mood.
colors:
  primary: "#5865f2"
...
Blurple banners, dark guild sidebar, channel-list at 2am gamer mood. Inspired by Discord. This is one of 54 curated showcase variations spanning two decades of web/UI design vocabulary.

## Colors

- **Primary (#5865f2):** The single decisive interaction color per view.
- **Primary Hover (#4752c4):** Pressed/hover state for primary.
- **On Primary (#ffffff):** Foreground on primary fills.
- **Surface (#313338):** Default page and card background.
- **Surface Muted (#2b2d31):** Section bands and code blocks.
- **Text (#f2f3f5):** Body and heading copy.
- **Text Muted (#b5bac1):** Captions and metadata.
- **Border (#1e1f22):** Hairline between cards, inputs, rows.
- **Border Strong (#404249):** Reinforced border on muted surfaces.
- **Success (#57f287):** Confirmation and completion states.
- **Danger (#ed4245):** Destructive actions and validation errors.
- **Warning (#fee75c):** Non-blocking cautions.
- **Info (#5865f2):** Neutral informational states.
- **Focus Ring (#5865f2):** Keyboard focus indicator at 2px outer offset.
